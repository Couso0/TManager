...
function TaskItem({ task }: TaskItemProps) {
  ...
  const { getTask, openModalForEdit, deleteTask, updateTaskCompletion } = useTasks(); // Asegúrate de que updateTaskCompletion exista
      ...
      <div className="mt-auto flex justify-between items-center">
        ...
        <div>
          <div className="flex items-center gap-3 text-gray-400 text-[1.2rem]">
            <ToggleSwitch completed={task.completed} onToggle={handleCompleteToggle} /> {/* Reemplazo aquí */}
            <button
